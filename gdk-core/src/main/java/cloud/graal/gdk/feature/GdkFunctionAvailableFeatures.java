...
/**
 * Replaces <code>FunctionAvailableFeatures</code> to hide auto-selected GDK
...
@Singleton
public class GdkFunctionAvailableFeatures extends FunctionAvailableFeatures {
     ...
     */
    public GdkFunctionAvailableFeatures(List<Feature> features) {
