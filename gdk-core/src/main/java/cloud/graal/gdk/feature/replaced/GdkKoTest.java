...
@Singleton
public class GdkKoTest extends KoTest {
    ...
    public void doApply(GeneratorContext generatorContext) {
        ...
        GdkCloud cloud = context.getCloud();

        if (cloud != NONE || context.isPlatformIndependent()) {
            // Configure Kotest for everything but the LIB_MODULE

            // Note: GdkCloud.NONE here would be if a user selected a feature or a service but no cloud
