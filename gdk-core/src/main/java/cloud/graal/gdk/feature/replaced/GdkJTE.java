...
@Replaces(JTE.class)
@Singleton
public class GdkJTE extends JTE implements ViewFeature, MicronautServerDependent {
    ...
    private BuildPlugin gradlePlugin(GeneratorContext generatorContext) {
        ...
        GradlePlugin.Builder builder = GradlePlugin.builder()
                .id("gg.jte.gradle")
                .extension(new RockerWritable(gdkGradlePluginJTE.template(patchKapt, gradleDsl.orElse(GradleDsl.KOTLIN), JTE_SRC_DIR)))
    ...
    private BuildPlugin mavenPlugin(GeneratorContext generatorContext) {
        ...
        return MavenPlugin.builder()
                ...
                .extension(new RockerWritable(gdkMvnPluginJTE.template(coordinate.getGroupId(),
