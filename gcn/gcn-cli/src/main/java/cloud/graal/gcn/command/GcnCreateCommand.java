...
import cloud.graal.gcn.model.GcnCloud.AvailableClouds;
import cloud.graal.gcn.model.GcnProjectType;
import cloud.graal.gcn.model.GcnService;
import cloud.graal.gcn.model.GcnService.AvailableServices;
 ...
 * @since 1.0.0
 */
public abstract class GcnCreateCommand extends GcnBaseCommand {
    ...
    @ReflectiveAccess
    protected List<GcnCloud> clouds = new ArrayList<>();
    ...
    @ReflectiveAccess
    protected List<GcnService> services = new ArrayList<>();
     ...
     * Project creator.
     */
    protected final GcnProjectCreator projectCreator;
     ...
     */
    protected GcnCreateCommand(GcnProjectCreator projectCreator,
