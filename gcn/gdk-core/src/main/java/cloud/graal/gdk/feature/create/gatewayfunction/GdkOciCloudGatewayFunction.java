 ...
 */
@Singleton
public class GdkOciCloudGatewayFunction extends AbstractGdkCloudGatewayFunction {
     ...
     */
    public GdkOciCloudGatewayFunction(OracleRawFunction oracleRawFunction) {
    ...
    public String getName() {
        return "gdk-oci-cloud-gateway-function";
    }
}
