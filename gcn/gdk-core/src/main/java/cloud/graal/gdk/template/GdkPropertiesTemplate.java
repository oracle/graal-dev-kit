...
public class GdkPropertiesTemplate extends DefaultTemplate {

    private final Properties properties;

    private final Map<String, Object> originalConfig;

    public GdkPropertiesTemplate(String path, Map<String, Object> config) {
        this(DEFAULT_MODULE, path, config);
    }

    public GdkPropertiesTemplate(String module, String path, Map<String, Object> config) {
        super(module, path);
