...
import static cloud.graal.gcn.model.GcnService.SECRETMANAGEMENT;

/**
 * Base class for secret management service features.
 *
 * @since 1.0.0
 */
public abstract class AbstractSecretManagementFeature extends AbstractGcnServiceFeature {
