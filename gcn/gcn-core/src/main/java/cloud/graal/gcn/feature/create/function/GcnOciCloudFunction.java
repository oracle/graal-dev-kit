...
/**
 * OCI create-function feature.
 *
 * @since 1.0.0
 */
@Singleton
public class GcnOciCloudFunction extends AbstractGcnCloudFunction {
     ...
     */
    public GcnOciCloudFunction(OracleRawFunction oracleRawFunction) {
