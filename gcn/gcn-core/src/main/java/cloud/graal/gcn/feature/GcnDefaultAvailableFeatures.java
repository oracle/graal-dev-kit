...
/**
 * Replaces <code>DefaultAvailableFeatures</code> to hide auto-selected GCN
...
@Singleton
public class GcnDefaultAvailableFeatures extends DefaultAvailableFeatures {
     ...
     */
    public GcnDefaultAvailableFeatures(List<Feature> features) {
