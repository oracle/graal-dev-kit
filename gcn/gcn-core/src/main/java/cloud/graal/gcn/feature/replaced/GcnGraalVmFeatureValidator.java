...
/**
 * Replaces GraalVMFeatureValidator to remove the JDK 21 GraalVM check.
 */
@Singleton
@Replaces(GraalVMFeatureValidator.class)
public class GcnGraalVmFeatureValidator extends GraalVMFeatureValidator {
