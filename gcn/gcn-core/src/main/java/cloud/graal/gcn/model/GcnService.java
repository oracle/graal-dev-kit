...
public enum GcnService {
    ...
    static {
        SUPPORTED = Arrays.stream(values())
                .filter(c -> c != GcnService.TESTING)
                .toArray(GcnService[]::new);
    }
    ...
    GcnService(String title, String description) {
        this.title = title;
        this.description = description;
        this.documentationModuleName = null;
    }

    GcnService(String title, String description, String documentationModuleName) {
        this.title = title;
        this.description = description;
    ...
    /**
     * @return the subset of GcnService enum values that are currently supported
     */
    public static GcnService[] supportedValues() {
        return SUPPORTED;
    }
    ...
    public static class AvailableServices implements Iterable<String> {
        ...
        public Iterator<String> iterator() {
            return Arrays.stream(GcnService.supportedValues())
                    .map(Enum::name)
