...
@Replaces(JTE.class)
@Singleton
public class GcnJTE extends JTE implements ViewFeature, MicronautServerDependent {

    public static final String ARTIFACT_ID_MICRONAUT_VIEWS_JTE = "micronaut-views-jte";
    public static final String JTE_GROUP_ID = "gg.jte";
    public static final String JTE_NATIVE_RESOURCES = "jte-native-resources";
    ...
    private BuildPlugin gradlePlugin(GeneratorContext generatorContext) {
        ...
        GradlePlugin.Builder builder = GradlePlugin.builder()
                .id("gg.jte.gradle")
                .extension(new RockerWritable(gcnGradlePluginJTE.template(patchKapt, gradleDsl.orElse(GradleDsl.KOTLIN), JTE_SRC_DIR)))
    ...
    private BuildPlugin mavenPlugin(GeneratorContext generatorContext) {
        ...
        return MavenPlugin.builder()
                ...
                .extension(new RockerWritable(gcnMvnPluginJTE.template(coordinate.getGroupId(),
