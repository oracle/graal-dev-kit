...
/**
 * Base class for all GDK Picocli command classes.
 * Based on io.micronaut.starter.cli.command.BaseCommand.
 *
 * @since 1.0.0
 */
public abstract class GdkBaseCommand implements ConsoleOutput, Callable<Integer> {
    ...
    @Mixin
    @ReflectiveAccess
    protected final GdkCommonOptionsMixin commonOptions = new GdkCommonOptionsMixin();
