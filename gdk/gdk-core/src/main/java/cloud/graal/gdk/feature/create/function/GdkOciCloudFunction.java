 ...
 */
@Singleton
public class GdkOciCloudFunction extends AbstractGdkCloudFunction {
     ...
     */
    public GdkOciCloudFunction(OracleRawFunction oracleRawFunction) {
