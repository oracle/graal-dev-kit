 ...
 */
public class GdkFeatures extends Features {

    private final GdkGeneratorContext context;
     ...
     */
    public GdkFeatures(GdkGeneratorContext context,
    ...
    public String toString() {
        return "GdkFeatures(" + super.toString() + ')' +
                " BuildTool: " + build() +
